...
<body>
	...
	<div class="container">
		<h1 class="text-center"> Welcome! Kindly enter the required details </h1>
			...
			<div class="col-lg-6">
				<div class="card">
					...
					<form action="register_post.php" method="post">
						...
						<input type="submit" name="submit_post"  value="submit_post" class="btn btn-success m-auto d-block" />
					</form>
